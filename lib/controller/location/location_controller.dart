...
class LocationController extends GetxController implements GetxService {
  ...
  List<AddressModel> get alladdrslist => _allAddressList!;
...
//! default lat log
  ...
  Future<AddressModel> getCurrentLocation(bool fromAddress,
    ...
    try {
      ...
      _myPosition = Position(
        latitude: defaultLatLng != null ? defaultLatLng.latitude : lat,
        ...
        longitude: defaultLatLng != null ? defaultLatLng.longitude : log,
  ...
  Future<void> getAddressList() async {
    ...
    if (response.statusCode == 200) {
      ...
      //  print('mujahid testging of zoneid');
  ...
  void autoNavigate(AddressModel address, bool fromSignUp, String route,
      bool canRoute) async {
    if (!GetPlatform.isWeb) {
      if (Get.find<LocationController>().getUserAddress().zoneId !=
          address.zoneId) {
